...
module.exports.run = async (client, message, args) => {
  ...
  if (!message.member.hasPermissions("MUTE_MEMBERS") || !message.guild.owner) return message.channel.send('Kamu tidak Mempunyai Akses!');
  ...
  try {
    await message.channel.send(` Role ${muterole.name} sudah terpasang.`)
    }
    catch (e) {
        message.channel.send(`Role ${muterole.name} sudah terpasang untuk <@${mutee.id}>. Tapi, saat kami mencoba mengirim pesan intim, mereka menguncinya.`)
    };
